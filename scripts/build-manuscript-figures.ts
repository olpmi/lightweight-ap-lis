...
function writeReadme(outputs: ComposedOutput[]): void {
  ...
  lines.push(
    ...
    'The names are placeholders rather than plausible ones — "PATIENT, Test",',
    '"REFERRER, Test", "ZZZTEST-STAFF, Dr. Alpha" — so no panel can be read as a real',
    'person\'s record, and no value in these figures traces to a real one.',
    ''
  );
